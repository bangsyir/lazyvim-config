return {
  ...
  opts = {
    servers = {
      ...
      --     Lua = {
      --       diagnostics = {
      --         globals = { "vim" }, -- Add "vim" as a known global
      --       },
      --       workspace = {
      --         -- This helps the language server find Neovim's runtime files
      --         library = {
      --           vim.env.VIMRUNTIME,
      --           -- Add paths to your installed plugins (e.g., via lazy.nvim)
      --           -- require("lazy.core.config").get().root .. "/plugins",
      --         },
      --       },
      --     },
      --   },
